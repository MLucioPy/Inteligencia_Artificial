...
PASSOS_TEMPO = 30 
print("Estruturando janelas de tempo...")
X_seq, y_seq = criar_sequencias_temporais(X_raw, y_raw, PASSOS_TEMPO)

# ===================================================================
# A MÁGICA: Embaralhamento de Blocos (Cura do R2 Negativo)
# ===================================================================
# A cronologia DENTRO do bloco de 30 passos está intacta.
# Embaralhar a ordem dos blocos garante variância alta no Teste!
X_train, X_test, y_train, y_test = train_test_split(X_seq, y_seq, test_size=0.20, random_state=42)

print("=========================================================")
print("      INICIANDO O TREINAMENTO LSTM (EQUILÍBRIO IDEAL)    ")
print("=========================================================")
...
# 4. Treinamento Otimizado (Batch 128 é o ponto doce de velocidade/precisão)
history = model.fit(
    X_train, y_train, 
    epochs=50, 
    batch_size=128, 
